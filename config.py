...
class Config:
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1615421798:AAGTPS678H1Xa_u9M-LObOdTO3nmBurI1co")
    ...
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/usetgrobot")
    ...
    # please reopen
    # https://github.com/Sh-Jil/MyTelegramOrgRoBot/issues/3
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/usetgrobot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @Shijilraj")

...
- can be found on [Telegram](https://telegram.dog/usetgrobot)

🙄 [@useTGxBot](https://telegram.dog/usetgrobot) **is the only Telegram RoBot, which is using this repository code**. 🙄😬
...
```sh
git clone https://GitHub.com/Sh-Jil/MyTelegramOrgRoBot.git
```
